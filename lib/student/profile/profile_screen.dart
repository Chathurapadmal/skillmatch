...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Future<void> _editField() async {
    final currentField = (_profile?['industry'] as String?) ??
        (_profile?['field'] as String?) ??
        'IT & Software';
  ...
  Widget build(BuildContext context) {
    ...
    final String? field =
        (_profile?['industry'] as String?) ?? (_profile?['field'] as String?);
                  ...
                  children: [
                    ...
                    Wrap(
                      ...
                      children: [
                        ...
                        if (githubConnected && _isTechIndustry(field))
